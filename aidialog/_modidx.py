...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'aidialog.dialog': { 'aidialog.dialog.Attachment': ('dialog.html#attachment', 'aidialog/dialog.py'),
            ...
            'aidialog.msg_parts': { 'aidialog.msg_parts.FullResponse': ('msg_parts.html#fullresponse', 'aidialog/msg_parts.py'),
                                    ...
                                    'aidialog.msg_parts._mk_content': ('msg_parts.html#_mk_content', 'aidialog/msg_parts.py'),
            ...
            'aidialog.render': { 'aidialog.render.Dialog.__ft__': ('render.html#dialog.__ft__', 'aidialog/render.py'),
                                 'aidialog.render.Message.__ft__': ('render.html#message.__ft__', 'aidialog/render.py'),
                                 'aidialog.render._hl': ('render.html#_hl', 'aidialog/render.py'),
                                 'aidialog.render._mm': ('render.html#_mm', 'aidialog/render.py'),
                                 'aidialog.render._msg_input': ('render.html#_msg_input', 'aidialog/render.py'),
                                 'aidialog.render._msg_output': ('render.html#_msg_output', 'aidialog/render.py'),
                                 'aidialog.render._outputs': ('render.html#_outputs', 'aidialog/render.py'),
                                 'aidialog.render._prep_out': ('render.html#_prep_out', 'aidialog/render.py'),
                                 'aidialog.render.katex_hdrs': ('render.html#katex_hdrs', 'aidialog/render.py'),
                                 'aidialog.render.math_mode': ('render.html#math_mode', 'aidialog/render.py'),
                                 'aidialog.render.md2ft': ('render.html#md2ft', 'aidialog/render.py'),
                                 'aidialog.render.render_message': ('render.html#render_message', 'aidialog/render.py')}}}
