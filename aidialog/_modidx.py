...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'aidialog.dialog': { 'aidialog.dialog.Attachment': ('dialog.html#attachment', 'aidialog/dialog.py'),
            ...
            'aidialog.diff': { 'aidialog.diff.DlgDiff': ('diff.html#dlgdiff', 'aidialog/diff.py'),
                               'aidialog.diff.DlgDiff.__bool__': ('diff.html#dlgdiff.__bool__', 'aidialog/diff.py'),
                               'aidialog.diff._facets': ('diff.html#_facets', 'aidialog/diff.py'),
                               'aidialog.diff._norm_out': ('diff.html#_norm_out', 'aidialog/diff.py'),
                               'aidialog.diff.diff_dlgs': ('diff.html#diff_dlgs', 'aidialog/diff.py')},
