...
# %% auto #0
__all__ = ['UNSUPPORTED_MSG', 'im_max', 'jwrap', 'to_local_time', 'media_item', 'resize_img', 'output_parts', 'merge_media',
           'dlg2hist', 'dlg2chat', 'chat2dlg', 'reply2dlg', 'dlg2reply']
...
im_max = 512**2  # image-area budget for LLM context; images are resized down to this in `prep_img`
